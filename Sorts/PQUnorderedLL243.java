/**compile Multiple: javac -cp .;algs4_sts.jar; Transaction243.java PQUnorderedLL243.java
  *run: java -cp ../;.;algs4_sts.jar; sorts.PQUnorderedLL243*/
...
public class PQUnorderedLL243<Key extends Comparable<Key>>
{
	Node head = new Node();
	Node tail = new Node();
	...
	public PQUnorderedLL243(int capacity)
	{
	...
	public static void main(String[] args)
	{
		...
		PQUnorderedLL243 pq = new PQUnorderedLL243(5);
		//(1) Shuffle array prior to insert
		StdRandom.shuffle(t1);
		pq.insertArray(t1);
		pq.printPQ();
		pq.getMaxPQ();
