...
import java.math.*;
  ...
  *compile Single: javac -cp .;algs4_sts.jar; DoublingTest2319.java
  *compile Multiple: javac -cp .;algs4_sts.jar; Quicksort2319_DoublingTest.java DoublingTest2319.java
  *run: java -cp ../;.;algs4_sts.jar; sorts.DoublingTest2319
  **/
...
public class DoublingTest2319
{
	...
	//contructor
	public DoublingTest2319(int N)
	{
		DoublingTest2319.N = N;
		DoublingTest2319.a = new int[N];	
		DoublingTest2319.setArray(N);
	}
	...
	{ 
		DoublingTest2319.timer = new Stopwatch();
	}
	...
	StdOut.printf("%7s %5s\n", "**", "****");
	int ctr =0;
		Quicksort2319_DoublingTest qs = new Quicksort2319_DoublingTest();
		//for (int N = 10; ctr<numOfTrials; N += N)
		for (int N = 250; ctr<numOfTrials; N += N)
		{ // Print time for problem size N.
			DoublingTest2319 dt = new DoublingTest2319(N);
			dt.startTimer(N);
