/**compile Multiple: javac -cp .;algs4_sts.jar; Transaction243.java PQOrderedArray243.java
  *run: java -cp ../;.;algs4_sts.jar; sorts.PQOrderedArray243*/
...
public class PQOrderedArray243<Key extends Comparable<Key>>
{
	...
	//constructor
	public PQOrderedArray243(int capacity)
	{
	...
	public void insertTransaction243s(Key[] v)
	{
		...
		//(1)NOTE:	 Must shuffle the list to make the Keys unordered	
	...
	{
		try{
			//System.out.println("Transaction243s in PQOrderedArray243:");
	...
	{		
		...
		PQOrderedArray243 pq = new PQOrderedArray243(capacity);//PQOrderedArray243 can take up to 10 transactions in the transaction array
		...
		//Insert Transaction243s array into PriortyQueue (PQOrderedArray243)
