...
The experiment runs 16 (0-15) and returns the array length and the run time of the called class (PQUnorderedArray2433), which finds 
the max and min values in the array.*/
  ...
  *compile Single: javac -cp .;algs4_sts.jar; DoublingTest2433.java
  *compile Multiple: javac -cp .;algs4_sts.jar; Transaction2433.java PQUnorderedArray2433.java DoublingTest2433.java
  *run: java -cp ../;.;algs4_sts.jar; sorts.DoublingTest2433
  **/
...
public class DoublingTest2433
{
	...
	//contructor
	public DoublingTest2433(int N)
	{
		DoublingTest2433.N = N;
		DoublingTest2433.a = new int[N];	
		DoublingTest2433.setArray(N);
	}
	...
	{ 
		DoublingTest2433.timer = new Stopwatch();
	}
	...
	int N = 10;  //26 letter in the alphabet
		PQUnorderedArray2433 qs = new PQUnorderedArray2433();
		//for (int N = 10; ctr<numOfTrials; N += N)
		for (; ctr<numOfTrials; N += N)
		{ // contructor: Sets up Instance Variable a by calling setArray() method
			DoublingTest2433 dt = new DoublingTest2433(N);
			dt.startTimer(N);
